  ...
  group('Test LicenseRepository', () {
    ...
    test('test LicenseRepository no local license dev', () async {
      ...
      expect(
        ...
        throwsA(predicate((e) =>
            e is FatalException &&
            e.message == '.dart_tool/package_config.json is not up to date. `test/repo/test_data/no-local-license-dev/test_package-1.0.0-does-not-exist` does not exist anymore.')),
      );
    });
